...
musicRender.init();
/*
 * ajax请求方式:get :get delete head post:put post
 * get/post有什么区别：url,请求体。核心，引申出缓存，相对安全，大小，
 * dataType:请求过来的数据，是对客户端的影响，服务器返回的是字符串或buffer
 * cache:false请除get请求方式的缓存，也是在url后加一个随机数
 * 正则捕获：test/exec/match/replace.match不能捕获分组
 * */